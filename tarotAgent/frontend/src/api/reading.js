...
export const selectCards = (id, count) => api.post(`/api/readings/${id}/select-cards`, { count })
export const confirmSelection = (id) => api.post(`/api/readings/${id}/confirm-selection`)
